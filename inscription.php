        ...
        <div class="fond">
            <div class="alignement">
                ...
                <table>
                    <tr>
                        <td>Pseudo :</td>
                        <td> <input type="text" name="pseudo" value="<?php if (isset($_GET['pseudo'])) echo htmlentities($_GET['pseudo']); ?>" required></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><br /> <input type="password" name="mdp_verif" required><br /></td>
                    </tr>
                </table><br />
